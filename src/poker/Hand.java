...
public class Hand implements Comparable<Hand> {
    ...
    static private final long STRAIGHT_FLUSH_MASK = 0x11111L; //0x8888800000000L;
    static private final long ACE_LOW_STRAIGHT_FLUSH_MASK = 0x1111000000001L; //0x8888000000008L;
    ...
    static public Hand eval(CardSet cs) {
        ...
        for (int i = 0, n = Card.Rank.size; i < n; ++i) {
            ...
            if (test == mask) {
                ...
                List<Card> hand = (new CardSet(test)).toList();
    ...
    static public Hand eval(List<Card> hand, List<Card> board) {
